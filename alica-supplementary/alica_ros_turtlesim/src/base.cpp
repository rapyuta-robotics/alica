...
Base::Base(ros::NodeHandle& nh, ros::NodeHandle& priv_nh, const std::string& name, const std::string& roleset,
    ...
    essentials::SystemConfig::setHostname(name);
    sc->setRootPath(path);
    sc->setConfigPath(path + "/etc");

    // ALICA engine setting
    ae = new alica::AlicaEngine(
            new essentials::AgentIDManager(new essentials::AgentIDFactory()), roleset, master_plan, false);
