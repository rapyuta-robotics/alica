...
GoTo::GoTo()
    ...
    /*PROTECTED REGION ID(con1544160969061) ENABLED START*/  // Add additional options here
    /*PROTECTED REGION END*/
}
GoTo::~GoTo() {
    /*PROTECTED REGION ID(dcon1544160969061) ENABLED START*/  // Add additional options here
    /*PROTECTED REGION END*/
}
void GoTo::run(void* msg) {
    /*PROTECTED REGION ID(run1544160969061) ENABLED START*/  // Add additional options here
...
void GoTo::initialiseParameters() {
    /*PROTECTED REGION ID(initialiseParameters1544160969061) ENABLED START*/  // Add additional options here
...
/*PROTECTED REGION ID(methods1544160969061) ENABLED START*/  // Add additional methods here
/*PROTECTED REGION END*/
} /* namespace alica */
