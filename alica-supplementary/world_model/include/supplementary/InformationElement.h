...
class InformationElement
{
  public:
     ...
     */
    alica::AlicaTime getCreationTime() const { return this->creationTime; }
     ...
     */
    alica::AlicaTime getValidityTime() const { return this->validityTime; }
     ...
     */
    double getCertainty() const { return this->certainty; }
     ...
     */
    const T getInformation() const { return this->information; }
