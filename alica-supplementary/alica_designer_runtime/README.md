...
- Import: Import your local plans from a zip file.
- Export: Export your plans locally, starts the download of a zip file.
- Github
...
The plan designer supports two ways of importing and exporting plans:
- Using zip files
...
#### 3.1.1 Export
Simply click on the ‘+’ button in the top left corner of the page, and then click on Export.
...
#### 3.1.2 Import
Same as export, but click on Import, and select a zip file from your computer containing valid ALICA plan elements,
...
Click on ‘Git Import’ (see image above), and you’ll see the following form.
...
New Branch Name: Optional name for the new branch that will be created before changes are pushed to it. If left blank, a unique branch name will be decided by the backend.
