...
void TestBase::ConsumeCmdLineArguments(int argc, char** argv)
{
	...
	int option_index = 0;
	static struct option long_options[] = { {"masterplan", required_argument, NULL, 'm'}, {"m", required_argument, NULL,
																							'm'},
											{"rolesetdir", required_argument, NULL, 'd'}, {"rd", required_argument,
																							NULL, 'd'},
											{"roleset", required_argument, NULL, 'r'}, {"r", required_argument, NULL,
																						'r'},
											{"teamColour", required_argument, NULL, 'c'}, {"tc", required_argument,
																							NULL, 'c'},
											{"delayStart", required_argument, NULL, 't'}, {"ds", required_argument,
																							NULL, 't'},
											{"simulator", no_argument, NULL, 's'}, {"s", no_argument, NULL, 's'}, {
													"stepEngine", no_argument, NULL, 'e'},
...
void TestBase::PrintUsage()
{
	...
	cout
			...
			<< endl;
	cout << "\t--stepEngine\t\t\t Makes the control-loop of the ALICA engine triggered by the user instead of a timer."
			<< endl;
	cout << endl;
	cout << "Optional parameters (MSL):" << endl;
	cout << "\t--teamColour=[cyan|magenta]\t Defines the team colour of your team." << endl;
	cout << "\t--simulator\t\t\t Makes the control-loop of the ALICA engine triggered by the user instead of a timer."
			<< endl;
}
