 ...
 */
std::unique_ptr<alica::AlicaContext> makeAgent(const std::string& configPath, const std::string& agentName, alica::AgentId agentId, bool installLogger)
{
...
int main(int argc, char** argv)
{
    ...
    for (int i = 0; i < agentCount; ++i) {
        ...
        auto ac = makeAgent(configPath, name, 1000 + i, /*installLogger=*/i == 0);
        if (!ac) {
