...
bool TeamObserver::updateTeamPlanTrees()
{
    ...
    std::vector<uint64_t> deactivatedAgentIds;
 ...
 */
std::unique_ptr<SimplePlanTree> TeamObserver::sptFromMessage(uint64_t agentId, const IdGrp& ids, AlicaTime time) const
{
