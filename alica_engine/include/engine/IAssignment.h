...
class IAssignment
{
  public:
    ...
    virtual shared_ptr<vector<const alica::IRobotID *>> getRobotsWorking(EntryPoint *ep) = 0;
    virtual shared_ptr<vector<const alica::IRobotID *>> getRobotsWorking(long epid) = 0;
     ...
     */
    virtual shared_ptr<list<const alica::IRobotID *>> getRobotsWorkingAndFinished(EntryPoint *ep) = 0;
    /**
     ...
     * @return A shared_ptr of a list of int of robot ids
     */
    virtual shared_ptr<list<const alica::IRobotID *>> getUniqueRobotsWorkingAndFinished(EntryPoint *ep) = 0;
    /**
     ...
     * @return A shared_ptr of a list of int of robot ids
     */
    virtual shared_ptr<list<const alica::IRobotID *>> getRobotsWorkingAndFinished(long epid) = 0;
    /**
    ...
    const vector<const alica::IRobotID *> &getUnassignedRobotIds() const
    {
  ...
  protected:
     ...
     */
    vector<const alica::IRobotID *> unassignedRobotIds;
    /**
