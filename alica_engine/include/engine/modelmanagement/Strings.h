...
static const std::string plan_extension = ".pml";
static const std::string plantype = "plantype";
static const std::string plantype_extension = ".pty";
static const std::string behaviour = "behaviour";
...
static const std::string placeholderExtension = ".plc";
static const std::string placeholderMapping = "mapping";
static const std::string placeholderMappingExtension = ".plcm";
static const std::string placeholderImplementation = "implementation";
