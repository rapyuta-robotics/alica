...
public:
    ...
    std::shared_ptr<RunningPlan> getRunningPlan() const {return _runningPlan;}
    ...
    std::shared_ptr<ProblemDescriptor> generateProblemDescriptor() const;
...
private:
    ...
    std::shared_ptr<RunningPlan> _runningPlan;
