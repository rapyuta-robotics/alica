...
private:
    ...
    int _deferring;
    /**
     * Specifies whether this behavior requires custom parameters to be set in its blackboard.
     * If so, the corresponding autogenerated function will be called
     * Otherwise, it will simply receive a copy of its parents blackboard
     */
