...
typedef optional_ALIGN_TYPE(char), optional_ALIGN_TYPE(short), optional_ALIGN_TYPE(int), optional_ALIGN_TYPE(long), optional_ALIGN_TYPE(float),
        optional_ALIGN_TYPE(double), optional_ALIGN_TYPE(long double),

        optional_ALIGN_TYPE(char*), optional_ALIGN_TYPE(short*), optional_ALIGN_TYPE(int*), optional_ALIGN_TYPE(long*), optional_ALIGN_TYPE(float*),
        optional_ALIGN_TYPE(double*), optional_ALIGN_TYPE(long double*),
...
private:
    ...
    value_type const&& value() const optional_refref_qual { return *value_ptr(); }
...
public:
    ...
    optional_constexpr value_type const&& operator*() const optional_refref_qual { return assert(has_value()), std::move(contained.value()); }

    optional_constexpr14 value_type&& operator*() optional_refref_qual { return assert(has_value()), std::move(contained.value()); }
