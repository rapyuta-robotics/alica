 ...
 * <remarks>
 * The order of the variables in <paramref name="variables"/> is important. Each call to <c>ICompiledTerm.Evaluate</c>
 * or <c>ICompiledTerm.Differentiate</c> receives an array of numbers representing the point of evaluation. The i'th
 * number in this array corresponds to the i'th variable in <c>variables</c>.
 * </remarks>
 *
 ...
 */
shared_ptr<ICompiledTerm> TermUtils::compile(
        shared_ptr<Term> term, shared_ptr<vector<shared_ptr<Variable>>> variables) {
 ...
 */
double TermUtils::evaluate(
        shared_ptr<Term> term, shared_ptr<vector<shared_ptr<Variable>>> variables, shared_ptr<vector<double>> point) {
 ...
 * <remarks>The i'th value in <c>point</c> corresponds to the i'th variable in <c>variables</c>. In addition, the i'th
 * value in the resulting array is the partial derivative with respect to the i'th variable in
 * <c>variables</c>.</remarks>
 *
 ...
 */
shared_ptr<vector<double>> TermUtils::differentiate(
        shared_ptr<Term> term, shared_ptr<vector<shared_ptr<Variable>>> variables, shared_ptr<vector<double>> point) {
