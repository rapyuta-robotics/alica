...
public:
     ...
     * @param parameters The parameter values
     *
     * @return A tuple, where the first item is the gradient at arg and the second item is the value at arg. That is,
     * the second value is the same as running evaluate on arg and parameters.
     */
     ...
     * or <see cref="Evaluate"/>. That is, the variable at <c>Variables[i]</c> corresponds to the i-th element in the
     * <c>arg</c> parameter of <see cref="Differentiate"/> and <see cref="Evaluate"/>.
     * </remarks>
     */
     ...
     * The order of variables in this collection specifies the meaning of each argument in <see cref="Differentiate"/>
     * or <see cref="Evaluate"/>. That is, the variable at <c>Variables[i]</c> corresponds to the i-th element in the
     * <c>parameters</c> parameter of <see cref="Differentiate"/> and <see cref="Evaluate"/>.
     * </remarks>
     */
