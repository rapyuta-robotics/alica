...
public:
    ...
    static shared_ptr<Term> sum(
            shared_ptr<Term> v1, shared_ptr<Term> v2, vector<shared_ptr<Term>> rest = vector<shared_ptr<Term>>());
    static shared_ptr<Term> product(
            shared_ptr<Term> v1, shared_ptr<Term> v2, vector<shared_ptr<Term>> rest = vector<shared_ptr<Term>>());
    ...
    static shared_ptr<Term> boundedValue(
            shared_ptr<Term> arg, shared_ptr<Term> leftBound, shared_ptr<Term> rightBound, double steepness);
    static shared_ptr<Term> boundedRectangle(
            shared_ptr<TVec> arg, shared_ptr<TVec> leftLower, shared_ptr<TVec> rightUpper, double steepness);
