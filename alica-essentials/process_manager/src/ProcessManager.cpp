...
void ProcessManager::initCommunication(int argc, char **argv)
{
    ...
    processCommandSub =
        rosNode->subscribe(this->processCmdTopic, 10, &ProcessManager::handleProcessCommand, (ProcessManager *)this);
...
int main(int argc, char **argv)
{
    ...
    while (supplementary::FileSystem::pathExists("/sys/devices/system/cpu/cpu" +
                                                 to_string(supplementary::ProcessManager::numCPUs)))
    {
