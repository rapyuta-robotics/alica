...
TEST(BroadCastID, EqualWithBroadcastID)
{
    ...
    supplementary::AgentID* broadcastID1 = new supplementary::BroadcastID(bytesBroadcast1.data(), bytesBroadcast1.size());
    std::vector<uint8_t> bytesBroadcast2;
    supplementary::AgentID* broadcastID2 = new supplementary::BroadcastID(bytesBroadcast2.data(), bytesBroadcast2.size());
