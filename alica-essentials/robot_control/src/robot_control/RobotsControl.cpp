...
void RobotsControl::initPlugin(qt_gui_cpp::PluginContext &context)
{
    ...
    kickerStatInfoSub =
        rosNode->subscribe("/KickerStatInfo", 10, &RobotsControl::receiveKickerStatInfo, (RobotsControl *)this);
    sharedWorldInfoSub = rosNode->subscribe("/WorldModel/SharedWorldInfo", 10, &RobotsControl::receiveSharedWorldInfo,
                                            (RobotsControl *)this);
