...
void Robot::handleKickerStatInfo(
    pair<std::chrono::system_clock::time_point, msl_actuator_msgs::KickerStatInfoPtr> timeKSIpair)
{
...
void Robot::handleSharedWorldInfo(
    pair<std::chrono::system_clock::time_point, msl_sensor_msgs::SharedWorldInfoPtr> timeSWIpair)
{
