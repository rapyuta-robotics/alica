...
string RelayedMessage::getRosMessageHandler() {
    ...
    ret += "\t\tROS_ERROR_STREAM_THROTTLE(2,\"Exception while sending UDP message:\"<<e.what()<< \" Discarding "
           "message!\");\n";
...
string RelayedMessage::getRosJavaMessageHandler() {
    ...
    ret += "\t\t\tSystem.err.println(\"Exception while sending UDP message:\" + converted._TYPE + \" Discarding "
           "message!\");\n";
    ret += "\t\t}\n\n";
    ret += "\t}\n";
    ret += "\t}\n\n";
