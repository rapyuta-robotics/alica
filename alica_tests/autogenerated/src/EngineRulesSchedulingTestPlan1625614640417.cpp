...
std::shared_ptr<UtilityFunction> UtilityFunction1625614640417::getUtilityFunction(Plan* plan)
{
    ...
    DynamicAllocationRuleTestSummand* us = new DynamicAllocationRuleTestSummand(1.0);
    us->addEntryPoint(plan->getEntryPointByID(1625614705483));
    us->addEntryPoint(plan->getEntryPointByID(1625614710816));
