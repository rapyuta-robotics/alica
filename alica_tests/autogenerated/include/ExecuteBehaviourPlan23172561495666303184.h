...
/*PROTECTED REGION END*/
class ExecuteBehaviourPlan23172561495666303184 : public DomainPlan
{
public:
    ExecuteBehaviourPlan23172561495666303184();
    virtual ~ExecuteBehaviourPlan23172561495666303184();
