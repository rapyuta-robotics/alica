...
TEST_F(AlicaSerializationTest, serializeDeserializeC)
{
    ...
    ASSERT_EQ(msg_to_send.at(6), -1);
    ASSERT_EQ(msg_to_send.at(7), 0);
    ASSERT_EQ(msg_to_send.at(8), planBStateId);
    ...
    ASSERT_EQ(msg_to_send.at(14), -1);
    ASSERT_EQ(msg_to_send.at(15), 0);
    ASSERT_EQ(msg_to_send.at(16), emptyPlanStateId);
    ASSERT_EQ(msg_to_send.at(17), -1);
    ASSERT_EQ(msg_to_send.at(18), -1);
    ASSERT_EQ(msg_to_send.at(19), 0);
    ASSERT_EQ(msg_to_send.at(20), planAStateId);
    ASSERT_EQ(msg_to_send.at(21), 0);
    ASSERT_EQ(msg_to_send.at(22), emptyPlanStateId);
    ASSERT_EQ(msg_to_send.at(23), -1);
...
TEST_F(AlicaSerializationTest, serializeDeserializeD)
{
    ...
    ASSERT_EQ(msg_to_send.at(2), 1); // dynamic EP id is not 0
    ASSERT_EQ(msg_to_send.at(3), planDStateId);
    ASSERT_EQ(msg_to_send.at(4), 0);
    ASSERT_EQ(msg_to_send.at(5), emptyPlanStateId);
    ASSERT_EQ(msg_to_send.at(6), -1);
    ASSERT_EQ(msg_to_send.at(7), -1);
