...
TEST_F(AlicaEngineTest, planParser)
{
    ...
    for (const alica::Plan* plan : plans) {
        ...
        case 1402488870347:
            ...
            cout << "Transitions: " << endl;
            EXPECT_EQ(3u, plan->getTransitions().size()) << "Number of Transitions didnt fit GoalPlan.pml Transitions size." << endl;
            for (const alica::Transition* t : plan->getTransitions()) {
                cout << "\t" << t->getName() << " ID: " << t->getId() << endl;
                switch (t->getId()) {
                case 1402489173167:
        ...
        case 1402488437260:
            ...
            cout << "Transitions: " << endl;
            EXPECT_EQ(4u, plan->getTransitions().size()) << "Number of Transitions didnt fit MasterPlan.pml Transitions size." << endl;
            for (const alica::Transition* t : plan->getTransitions()) {
                cout << "\t" << t->getName() << " ID: " << t->getId() << endl;
                switch (t->getId()) {
                case 1402488557864:
