...
OtherPlan1418042819203::OtherPlan1418042819203(PlanContext& context)
        : DomainPlan(context)
{
...
UtilityFunction1418042819203::UtilityFunction1418042819203(IAlicaLogger& logger)
...
std::shared_ptr<UtilityFunction> UtilityFunction1418042819203::getUtilityFunction(Plan* plan)
{
    ...
    std::shared_ptr<UtilityFunction> function = std::make_shared<UtilityFunction>(0.5, 0.1, plan, _logger);
