...
SchedulingTestSequenceSubPlan21614964444419::SchedulingTestSequenceSubPlan21614964444419(PlanContext& context)
        : DomainPlan(context)
{
...
UtilityFunction1614964444419::UtilityFunction1614964444419(IAlicaLogger& logger)
