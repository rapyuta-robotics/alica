...
#include <alica_tests/plans/TestParameterPassingSubPlan.h>

namespace alica
{
TestParameterPassingSubPlan::TestParameterPassingSubPlan(PlanContext& context)
        : AlicaTestsPlan(context)
{
}

void TestParameterPassingSubPlan::onInit()
{
