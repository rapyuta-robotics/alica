				...
				for (alica::State* s : iter.second->getStates())
				{
					...
					switch (s->getId())
					{
						case 1402488646220:
							...
							break;
						case 1402489396914:
							checkState(s, 1402489396914, "Shoot", "", {1402488866727}, {1402489459382},
										{1402489460694});
							break;
						default:
							EXPECT_TRUE(false);
					...
					switch (t->getId())
					{
						case 1402488557864:
							checkTransition(t, 1402488557864, "GoalToSucGoal", "GoalToSucGoal", 1402488558741,
											1402488470615, 1402488536570, "MISSING_NAME", "", "", "", true);
							break;
						case 1402488517667:
							checkTransition(t, 1402488517667, "AttackToGoal", "AttackToGoal", 1402488519140,
											1402488437261, 1402488477650, "MISSING_NAME", "", "", "", true);
							break;
						case 1402488519757:
