 ...
 */
bool PreCondition1588069612661::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* gb)
{
 ...
 * Abstract Plans in DecisionState:
 */
bool PreCondition1588069615553::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* gb)
{
