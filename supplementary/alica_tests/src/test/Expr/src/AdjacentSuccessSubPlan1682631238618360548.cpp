 ...
 */
bool PreCondition1067314038887345208::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* gb)
{
 ...
 */
bool PreCondition597347780541336226::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* gb)
{
