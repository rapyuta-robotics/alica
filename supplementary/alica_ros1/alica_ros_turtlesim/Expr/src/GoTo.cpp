...
void GoTo::run()
{
    ...
    // move turtle to goal
    std::shared_ptr<turtlesim::ALICATurtleWorldModel> wm = LockedBlackboardRW(getGlobalBlackboard()).get<std::shared_ptr<turtlesim::ALICATurtleWorldModel>>("worldmodel");
