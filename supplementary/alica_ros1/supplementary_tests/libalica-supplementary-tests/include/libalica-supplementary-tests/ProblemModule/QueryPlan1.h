...
public:
    ...
    static std::shared_ptr<QueryPlan1UtilityFunction> create(alica::UtilityFunctionContext&);
};
...
public:
    // Factory method
    static std::shared_ptr<QueryPlan1RuntimeCondition> create(ConditionContext& context);
...
{
public:
    static std::shared_ptr<QueryPlan1RuntimeConditionConstraint> create(ConstraintContext& context);
