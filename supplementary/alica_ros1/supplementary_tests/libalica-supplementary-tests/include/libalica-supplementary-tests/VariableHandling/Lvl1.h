...
public:
    ...
    static std::shared_ptr<Lvl1UtilityFunction> create(alica::UtilityFunctionContext&);
};
...
public:
    // Factory method
    static std::shared_ptr<Lvl1RuntimeCondition> create(ConditionContext& context);
...
public:
    ...
    static std::shared_ptr<Lvl1RuntimeConditionConstraint> create(alica::ConstraintContext&);
};
