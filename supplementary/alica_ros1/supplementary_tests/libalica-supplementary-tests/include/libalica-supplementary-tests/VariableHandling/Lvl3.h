...
public:
    ...
    static std::unique_ptr<Lvl3UtilityFunction> create(alica::UtilityFunctionContext&);
};
...
{
public:
    static std::unique_ptr<Lvl3RuntimeCondition> create(ConditionContext& context);
...
public:
    ...
    static std::unique_ptr<Lvl3RuntimeConditionConstraint> create(alica::ConstraintContext&);
};
