...
QueryPlan11479556074049::QueryPlan11479556074049(PlanContext& context)
        : DomainPlan(context)
{
 ...
 *	- QP1Y (1479556572534)
 */
bool RunTimeCondition1479556084493::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* worldModels)
{
