 ...
 */
bool PreCondition1413201227586::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
{
 ...
 */
bool PreCondition1413201389955::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
{
