 ...
 */
bool PreCondition1529456610697::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* gb)
{
 ...
 *   - CountIndefinitely (1529456643148)
 */
bool PreCondition1529456611916::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* gb)
{
