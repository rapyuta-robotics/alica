 ...
 */
bool PreCondition1402488993122::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
{
 ...
 */
bool PreCondition1402488991641::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
{
 ...
 * Abstract Plans in GetBall:
 */
bool PreCondition1402489065962::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
{
 ...
 */
bool PreCondition1402489073613::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
{
