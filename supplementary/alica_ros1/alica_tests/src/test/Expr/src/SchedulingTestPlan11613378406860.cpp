 ...
 */
bool PreCondition1614960055821::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
{
 ...
 */
bool PreCondition1614960063843::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
{
