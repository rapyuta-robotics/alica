...
ConstraintTestPlan1414068524245::ConstraintTestPlan1414068524245(PlanContext& context)
        : DomainPlan(context)
{
 ...
 *	- Y (1414068576620)
 */
bool RunTimeCondition1414068566297::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* worldModels)
{
