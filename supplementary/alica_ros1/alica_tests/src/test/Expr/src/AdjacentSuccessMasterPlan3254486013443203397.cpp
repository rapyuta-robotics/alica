 ...
 */
bool PreCondition807250359520655888::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* gb)
{
 ...
 *   - AdjacentSuccessSubPlan (1682631238618360548)
 */
bool PreCondition289358204208851392::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* gb)
{
