 ...
 * Available Vars:
 */
bool PreCondition1402489131988::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
{
 ...
 *	- test (1403773747758)
 */
bool RunTimeCondition1403773741874::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
{
 ...
 * Available Vars:
 */
bool PostCondition1402489620773::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
{
 ...
 */
bool PreCondition1402489174338::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
{
 ...
 */
bool PreCondition1402489206278::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
{
 ...
 * Abstract Plans in Miss:
 */
bool PreCondition1402489218027::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
{
