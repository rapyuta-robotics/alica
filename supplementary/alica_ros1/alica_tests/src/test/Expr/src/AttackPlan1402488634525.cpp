 ...
 */
bool PreCondition1402489460549::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* gb)
{
 ...
 */
bool PreCondition1402489462088::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* gb)
{
