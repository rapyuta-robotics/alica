 ...
 */
bool PreCondition1413201370590::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
{
 ...
 *   - Attack (1402488848841)
 */
bool PreCondition1413201052549::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
{
 ...
 *   - Attack (1402488848841)
 */
bool PreCondition1413201367990::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
{
