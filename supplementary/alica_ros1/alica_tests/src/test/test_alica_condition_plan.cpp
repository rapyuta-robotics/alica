...
TEST_F(AlicaConditionPlan, solverTest)
{
    ...
    auto constraintUsingBehaviour = dynamic_cast<alica::ConstraintUsingBehaviour*>(alica::test::Util::getBasicBehaviour(ae.get(), 1414068597716, 0));
    ...
    // Solver just sets the result as the ids of the used variables
    ASSERT_EQ(alica::ConstraintUsingBehaviour::result.at(0), 1414068576620);
}
} // namespace
} // namespace alica
