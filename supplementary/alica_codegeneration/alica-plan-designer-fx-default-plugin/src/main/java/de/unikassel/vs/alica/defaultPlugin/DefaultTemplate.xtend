...
class DefaultTemplate {
        ...
        «FOR transition : outTransitions»
            «IF (transition.preCondition !== null && transition.preCondition.pluginName == "DefaultPlugin")»
                ...
                *   - «wrapper.abstractPlan.name» («wrapper.abstractPlan.id»)
                «ENDFOR»
                */
                bool PreCondition«transition.preCondition.id»::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
                 {
    ...
    def String expressionsPlanCheckingMethods(Plan plan) '''
        «IF (plan.preCondition !== null && plan.preCondition.pluginName == "DefaultPlugin")»
             ...
             */
            bool PreCondition«plan.preCondition.id»::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
            {
        ...
        «IF (plan.runtimeCondition !== null && plan.runtimeCondition.pluginName == "DefaultPlugin")»
             ...
             *	- «variable.name» («variable.id»)«ENDFOR»
             */
            bool RunTimeCondition«plan.runtimeCondition.id»::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm) {
        ...
        «IF (terminalState.postCondition !== null && terminalState.postCondition.pluginName == "DefaultPlugin")»
             ...
             *	- «variable.name» («variable.id»)«ENDFOR»
             */
            bool PostCondition«terminalState.postCondition.id»::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
            {
    ...
    def String expressionsBehaviourCheckingMethods(Behaviour behaviour) '''
        «IF (behaviour.runtimeCondition !== null && behaviour.runtimeCondition.pluginName == "DefaultPlugin")»
             ...
             *	- «variable.name» («variable.id»)«ENDFOR»
             */
            bool RunTimeCondition«behaviour.runtimeCondition.id»::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm) {
        ...
        «IF (behaviour.preCondition !== null && behaviour.preCondition.pluginName == "DefaultPlugin")»
             ...
             *	- «variable.name» («variable.id»)«ENDFOR»
             */
            bool PreCondition«behaviour.preCondition.id»::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
            {
        ...
        «IF (behaviour.postCondition !== null && behaviour.postCondition.pluginName == "DefaultPlugin")»
             ...
             *	- «variable.name» («variable.id»)«ENDFOR»
             */
            bool PostCondition«behaviour.postCondition.id»::evaluate(std::shared_ptr<RunningPlan> rp, const Blackboard* wm)
            {
