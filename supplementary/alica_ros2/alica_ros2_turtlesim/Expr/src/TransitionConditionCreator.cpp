        ...
        int64_t conditionId, TransitionConditionContext& context)
{
    ...
    case 748720375848597116:
        return std::bind(conditionMove2Init, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    case 974606107671315045:
        return std::bind(conditionInit2Move, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    case 2190266318562141841:
        return std::bind(conditionDefaultCondition, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
    default:
