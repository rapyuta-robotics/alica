...
#include <alica_templates_msgs/DummyAction.h>
...
{
public:
    ActionServerExample2379894799421542548(PlanContext& context);
...
private:
    ...
    ros::NodeHandle _nh;
    std::unique_ptr<actionlib::SimpleActionServer<alica_templates_msgs::DummyAction>> _actionServer;
    alica_templates_msgs::DummyFeedback _feedback;
    alica_templates_msgs::DummyResult _result;
    /*PROTECTED REGION END*/
};
