...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Plan Element</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public abstract class PlanElementImpl extends MinimalEObjectImpl.Container implements PlanElement {
	...
	protected EClass eStaticClass() {
		return AlicaPackage.Literals.PLAN_ELEMENT;
	}
	...
	public void setId(long newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlicaPackage.PLAN_ELEMENT__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlicaPackage.PLAN_ELEMENT__NAME, oldName, name));
	}
	...
	public void setComment(String newComment) {
		...
		comment = newComment;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AlicaPackage.PLAN_ELEMENT__COMMENT, oldComment, comment));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AlicaPackage.PLAN_ELEMENT__ID:
				return getId();
			case AlicaPackage.PLAN_ELEMENT__NAME:
				return getName();
			case AlicaPackage.PLAN_ELEMENT__COMMENT:
				return getComment();
		}
