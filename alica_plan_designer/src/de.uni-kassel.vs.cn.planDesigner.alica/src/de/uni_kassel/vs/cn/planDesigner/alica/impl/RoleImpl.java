 ...
 * @generated
 */
public class RoleImpl extends PlanElementImpl implements Role {
	/**
	...
	protected EClass eStaticClass() {
		return AlicaPackage.Literals.ROLE;
	}
	...
	public EList<Characteristic> getCharacteristics() {
		if (characteristics == null) {
			characteristics = new EObjectContainmentEList<Characteristic>(Characteristic.class, this, AlicaPackage.ROLE__CHARACTERISTICS);
		}
