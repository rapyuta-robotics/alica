...
import de.uni_kassel.vs.cn.planDesigner.ui.wizards.PMLNewDomainDescriptionConfigurationWizard;
...
public class DomainDescriptionLauncher implements IEditorLauncher{
	...
	public void open(IPath file) {
		...
		DomainDescription type = (DomainDescription) res.getContents().get(0);
		// Create a plantype configuration wizard and initialize it with the plantype
		PMLNewDomainDescriptionConfigurationWizard wiz = new PMLNewDomainDescriptionConfigurationWizard(type);
