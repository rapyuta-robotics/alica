...
public class PlanEditorActionBarContributor extends EditingDomainActionBarContributor {
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		// TODO: Actions are not working cause they have to be registered somewhere
		...
		viewMenu.add(new MatchWidthRetargetAction());
		viewMenu.add(new MatchHeightRetargetAction());
		
		// Do not add the menu since it is not working
