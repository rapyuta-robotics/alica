...
/**
 * This is the item provider adapter for a {@link de.uni_kassel.vs.cn.planDesigner.pmlextension.uiextensionmodel.Bendpoint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BendpointItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Bendpoint_xPos_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Bendpoint_xPos_feature", "_UI_Bendpoint_type"),
				 PmlUIExtensionModelPackage.Literals.BENDPOINT__XPOS,
				 true,
				 false,
				 false,
	...
	protected void addYPosPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Bendpoint_yPos_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Bendpoint_yPos_feature", "_UI_Bendpoint_type"),
				 PmlUIExtensionModelPackage.Literals.BENDPOINT__YPOS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Bendpoint_type") + " " + bendpoint.getXPos();
	}
