...
/**
 * This is the item provider adapter for a {@link de.uni_kassel.vs.cn.planDesigner.alica.TerminalState} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TerminalStateItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AlicaPackage.Literals.TERMINAL_STATE__POST_CONDITION);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TerminalState.class)) {
			case AlicaPackage.TERMINAL_STATE__POST_CONDITION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AlicaPackage.Literals.TERMINAL_STATE__POST_CONDITION,
