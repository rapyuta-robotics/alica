...
/**
 * This is the item provider adapter for a {@link de.uni_kassel.vs.cn.planDesigner.alica.Role} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoleItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AlicaPackage.Literals.ROLE__CHARACTERISTICS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Role.class)) {
			case AlicaPackage.ROLE__CHARACTERISTICS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AlicaPackage.Literals.ROLE__CHARACTERISTICS,
				 AlicaFactory.eINSTANCE.createCharacteristic()));
	}
