...
/**
 * This is the item provider adapter for a {@link de.uni_kassel.vs.cn.planDesigner.alica.PreCondition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PreConditionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PreCondition_enabled_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PreCondition_enabled_feature", "_UI_PreCondition_type"),
				 AlicaPackage.Literals.PRE_CONDITION__ENABLED,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((PreCondition)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PreCondition.class)) {
			case AlicaPackage.PRE_CONDITION__ENABLED:
