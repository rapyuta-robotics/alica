...
/**
 * This is the item provider adapter for a {@link de.uni_kassel.vs.cn.planDesigner.alica.Constant} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Constant_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Constant_name_feature", "_UI_Constant_type"),
				 AlicaPackage.Literals.CONSTANT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AlicaPackage.Literals.CONSTANT__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
