...
/**
 * This is the item provider adapter for a {@link de.uni_kassel.vs.cn.planDesigner.alica.Characteristic} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Characteristic_weight_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Characteristic_weight_feature", "_UI_Characteristic_type"),
				 AlicaPackage.Literals.CHARACTERISTIC__WEIGHT,
				 true,
				 false,
				 false,
	...
	protected void addCapabilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Characteristic_capability_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Characteristic_capability_feature", "_UI_Characteristic_type"),
				 AlicaPackage.Literals.CHARACTERISTIC__CAPABILITY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AlicaPackage.Literals.CHARACTERISTIC__VALUE,
				 true,
				 false,
				 true,
				 null,
